//
//  EnduranceFinishViewController.m
//  GripBall
//
...
-(void)createUI
{
    ...
    self.lblLHandScore = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-150.f,230.f, 80.f, 25.f)];
    ...
    self.lblRHandScore = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-150.f,300.f, 80.f, 25.f)];
