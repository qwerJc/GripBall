...
@interface ExplodeLHandViewController ()
@property (strong, nonatomic)ExplodeTestingLHandViewController *viewControllerTestingLHand;
@end

@implementation ExplodeLHandViewController
- (instancetype)init
{
    self = [super init];
    if (self) {
...
-(void)createUI{
    ...
    [lblTPrepareText2 setText:@"取力和用时比值最大的一次。"];
