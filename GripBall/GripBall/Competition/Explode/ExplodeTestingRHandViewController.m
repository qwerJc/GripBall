//
//  ExplodeTestingRHandViewController.m
//  GripBall
//
...
#import "ExplodeTestingRHandViewController.h"
...
@interface ExplodeTestingRHandViewController ()
@property (strong, nonatomic)ExplodeFinishViewController *viewControllerFinish;
        ...
        if (self.startValue<0) {
            ...
            if(self.endValue != value){
                ...
                if ((self.midValue>self.startValue)&&(self.midValue>self.endValue)) {
                    ...
                    NSLog(@"%d此次比值%@",self.practiceNumber,[NSString stringWithFormat:@"%d/%f",(int)self.midValue,(float)diffTime]);
